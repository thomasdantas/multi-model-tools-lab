...
- Template fonte: @templates/prd-template.md <!--`@ como path para o cursor e claude code apenas` -->
...
<critical>NÃO GERE O PRD SEM ANTES FAZER PERGUNTAS DE CLARIFICAÇÃO</critical>
<critical>EM HIPÓTESE NENHUMA, FUJA DO PADRÃO DO TEMPLATE DO PRD</critical>
